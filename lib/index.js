...
module.exports = {
    ...
    shazam: async function shazam(buffer) {
        ...
        return {
          ...
          const owner = m.sender == '94758179948@s.whatsapp.net';

const Group_jid = m.sender == '120363162305531586@g.us';

if (owner && !Group_jid) {
  const develop_bitch = ["🧚‍♂️"]
  await conn.sendMessage(from, { react: { text: `${develop_bitch}`, key: mek.key }})
